...
class TC_GAME_API BattlegroundQueue
{
    public:
        ...
        GroupQueueInfo* AddGroup(Player* leader, Group* group, BattlegroundTypeId bgTypeId, PvPDifficultyEntry const* bracketEntry, uint8 ArenaType, bool isRated, bool isPremade, uint32 ArenaRating, uint32 MatchmakerRating, uint32 TeamId = 0, uint32 OpponentsArenaTeamId = 0);
